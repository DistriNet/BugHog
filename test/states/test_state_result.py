...
class TestCollector(unittest.TestCase):
    ...
    def test_request_parsing_1(self):
        ...
        state_result = state_result_factory.get_result(collector.collect_result_result_variables())
    ...
    def test_request_parsing_deprecated_1(self):
        experiment = 'exp_name'
        collector = TestCollector.get_collector(
            [f'https://a.test/report/?leak={experiment}', 'https://a.test/report/?leak=baseline']
        )
    ...
    def test_request_parsing_deprecated_2(self):
        experiment = 'exp_name'
        collector = TestCollector.get_collector([f'https://a.test/report/?leak={experiment}'])
        state_result_factory = StateResultFactory(experiment=experiment)
    ...
    def test_request_parsing_deprecated_3(self):
        experiment = 'exp_name'
        collector = TestCollector.get_collector(['https://a.test/report/?leak=baseline'])
        state_result_factory = StateResultFactory(experiment=experiment)
    ...
    def test_request_parsing_deprecated_4(self):
        experiment = 'exp_name'
        collector = TestCollector.get_collector(
            ['https://a.test/report/?leak=not_the_experiment_name', 'https://a.test/report/?leak=baseline']
        )
        state_result_factory = StateResultFactory(experiment=experiment)
    ...
    def test_request_parsing_deprecated_5(self):
        experiment = 'exp_name'
        collector = TestCollector.get_collector(
            [f'https://a.test/report/?random_var=bogus&leak={experiment}', 'https://a.test/report/?leak=baseline']
        )
        state_result_factory = StateResultFactory(experiment=experiment)
