...
def get_default_evaluation_parameters(browser_name: str, mech_group: str, sequence_limit: int=50, only_releases: bool=True) -> EvaluationParameters:
    ...
    for browser_name in ['chromium', 'firefox']:
        for mech_group in mech_groups:
            if mech_group == 'all_reproduced':
                ...
                sequence_limit = 50
            params = get_default_evaluation_parameters(
                browser_name,
                mech_group,
