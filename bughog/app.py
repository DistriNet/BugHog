...
def create_app():
    try:
        ...
        from bughog.web.blueprints.api import api
        from bughog.web.blueprints.experiments import exp
        ...
        logger.critical('Something went wrong during initialization...', exc_info=True)
        raise e
