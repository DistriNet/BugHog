...
class MongoDB:
    ...
    def store_result(self, eval_params: EvaluationParameters, result: ExperimentResult):
        ...
        query = {
            ...
            'padded_browser_version': result.padded_subject_version,
            'browser_config': subject_config.subject_setting,
        ...
        update = {
            '$set': {
                ...
                'result_variables': result.result_variables,
    ...
    def get_result(self, params: EvaluationParameters, state: State) -> Optional[ExperimentResult]:
        ...
        if document:
            return ExperimentResult(
                ...
                document['executable_origin'],
                document['state'],
                document['raw_results'],
                document['result_variables'],
                document['dirty'],
            )
        else:
    ...
    def get_evaluated_states(
        ...
        collection = self.__get_data_collection(params)
        query = {
            'browser_config': params.subject_configuration.subject_setting,
            'experiment': params.evaluation_range.experiment_name,
            'state.browser_name': params.subject_configuration.subject_name,
            'results': {'$exists': True},
        ...
        for doc in cursor:
            ...
            state.result_variables = doc['result_variables']
            states.append(state)
        return states
    ...
    def get_documents_for_plotting(self, params: EvaluationParameters, releases: bool = False) -> list:
        ...
        query = {
            ...
            'browser_config': subject_config.subject_name,
        ...
        if evaluation_range.revision_number_range:
            query['state.revision_number'] = {
                '$gte': evaluation_range.revision_number_range[0],
                '$lte': evaluation_range.revision_number_range[1],
            }
