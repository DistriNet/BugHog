...
import bughog.browser.binary.factory as binary_factory
...
class Browser:
    ...
    def __init__(
        self, browser_config: SubjectConfiguration, binary: Binary
    ) -> None:
    ...
    def get_browser(
        ...
        if browser_config.subject_name == 'chromium':
            return Chromium(browser_config, eval_config, binary)
        elif browser_config.subject_name == 'firefox':
