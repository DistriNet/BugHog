...
from bci.subject.browser.binary.artisanal_manager import ArtisanalBuildManager
...
class BrowserBinary:
    ...
    def list_artisanal_binaries(bin_folder_path: str, executable_name: str):
        return BrowserBinary._get_artisanal_manager(bin_folder_path, executable_name).get_artisanal_binaries_list()
